...
sessionsRouter.post("/login", passport.authenticate("login", { failureRedirect: "faillogin", session: true }), sessionsController.login);
sessionsRouter.get("/faillogin", sessionsController.failLogin);
sessionsRouter.get("/github", passport.authenticate("github", { scope: ["user:email"] }));
sessionsRouter.get("/githubcallback", passport.authenticate("github", { failureRedirect: "/login", session: true }), sessionsController.githubLogin);
